...
export const personalTrainingSchema = [
    { name: '1 op 1 personal training', time: 'Minimaal 6 maanden', quantity: '1x per week 60m', price: '€ 200 excl. btw' },
    { name: '1 op 1 personal training', time: 'Minimaal 6 maanden', quantity: '2x per week 60m', price: '€ 300 excl. btw' },
    ...
    { name: 'Sportschool buddy', time: 'Eenmalig', quantity: '1x 90m', price: '€ 50 excl. btw' },
    { name: 'Sportschool buddy', time: 'Minimaal 3 maanden', quantity: '1x per week 60m', price: '€ 200 excl. btw' },
    { name: 'Sportschool buddy', time: 'Minimaal 1 maand', quantity: '2x per week 60m', price: '€ 300 excl. btw' },
    { name: 'Voeding + training schema', time: '-', quantity: '1x (kan door de tijd heen aangepast worden)', price: '€ 30 excl. btw' },
];
