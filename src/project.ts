export enum projectVariables {
    ...
    COMPANY_PHONE = '637199776',
    COMPANY_PHONE2 = '619238149',
    COMPANY_EMAIL = 'info@lifestyle-pt.nl',
    COMPANY_WEBSITE = 'lifestylepersonaltraining-zeist.nl',
    COMPANY_FACEBOOK = '#',
    COMPANY_INSTAGRAM = '#',
    COMPANY_TWITTER = '#',
    COMPANY_YOUTUBE = '#',
    COMPANY_LINKEDIN = 'https://www.linkedin.com/in/sem-van-de-griendt-1b9617162/',
    COMPANY_KVK = '82800162',
    COMPANY_BTW = '',
    COMPANY_IBAN = '',
