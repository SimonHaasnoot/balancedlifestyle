                ...
                <DefaultContainer maxWidth="lg" component="section">
                    <Box sx={{ maxWidth: isTabletOrSmaller ? '100%' : '70%' }}>
                        <Typography variant="body1">
                            <div>
                                Ik heb jaren met extreme huidklachten rondgelopen. De milde huidklachten ontstonden toen ik 15 was. In het begin
                                maakte ik mij weinig zorgen en was ik ervan overtuigd dat de pubertijd de oorzaak was van mijn huidproblemen. 4 Jaar
                                later, tal van doktersbezoeken en antibioticakuren verder werden mijn problemen niet minder, maar juist erger. Mijn
                                milde huidklachten ontwikkelden zich tot zeer ernstige huidklachten. De angst voor chronische klachten nam toe.
                                Evengoed als mijn onzekerheid in het dagelijks leven. Naast fysieke klachten ging ik er mentaal ook aan onder door.
                                Het werd een obsessie, waardoor mijn zelfbeeld met de tijd snel achteruit ging.
                                <br /> <br />
