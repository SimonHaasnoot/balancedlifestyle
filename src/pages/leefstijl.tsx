            ...
            <Layout location={props.location}>
                ...
                <Box sx={{ background: theme.palette.grey[100] }} component="section">
                    <DefaultContainer maxWidth="lg" sx={{ textAlign: 'center' }} doublePadding>
                        ...
                        <Grid2 container spacing={isMobile ? 3 : 6} sx={{ textAlign: 'left', alignItems: 'center' }}>
                            <Grid2 xs={12} md={7}>
                            ...
                            <Grid2 xs={12} md={5}>
                                <Box sx={{ borderRadius: 3, overflow: 'hidden', boxShadow: '0 8px 30px rgba(0,0,0,0.3)', height: isMobile ? 250 : 400, position: 'relative', '&:hover .img-zoom': { transform: 'scale(1.06)' } }}>
                                    <Box className="img-zoom" sx={{ position: 'absolute', inset: 0, transition: 'transform 0.5s ease' }}>
                                        <StaticImage src="../images/2026/2026-42.jpg" alt="Leefstijl" style={{ width: '100%', height: '100%', objectFit: 'cover' }} />
                                    </Box>
                                </Box>
                            </Grid2>
                        </Grid2>
                        ...
                        <Grid2 container spacing={isMobile ? 2 : 3}>
                            {[
                                ...
                                <Grid2 xs={12} sm={6} md={3} key={pijler.title}>
                                    <Box sx={{
                                        p: 3,
                                        height: '100%',
                                        borderRadius: 3,
                        ...
                        <Box sx={{
                            ...
                            <Box sx={{
                                ...
                                <Box className="gallery-img" sx={{ position: 'absolute', inset: 0, transition: 'transform 0.6s ease' }}>
                                    <StaticImage src="../images/2026/2026-40.jpg" alt="Leefstijl training" style={{ width: '100%', height: '100%', objectFit: 'cover' }} />
                                </Box>
                            ...
                            <Box sx={{
                                ...
                                <Box className="gallery-img" sx={{ position: 'absolute', inset: 0, transition: 'transform 0.6s ease' }}>
                                    <StaticImage src="../images/2026/2026-23.jpg" alt="Leefstijl coaching" style={{ width: '100%', height: '100%', objectFit: 'cover' }} />
                                </Box>
                            </Box>
                            ...
                            <Box sx={{
                                ...
                                <Box className="gallery-img" sx={{ position: 'absolute', inset: 0, transition: 'transform 0.6s ease' }}>
                                    <StaticImage src="../images/2026/2026-30.jpg" alt="Leefstijl beweging" style={{ width: '100%', height: '100%', objectFit: 'cover' }} />
                                </Box>
                            </Box>
                            ...
                            <Box sx={{
                                ...
                                <Box className="gallery-img" sx={{ position: 'absolute', inset: 0, transition: 'transform 0.6s ease' }}>
                                    <StaticImage src="../images/2026/2026-41.jpg" alt="Leefstijl resultaat" style={{ width: '100%', height: '100%', objectFit: 'cover' }} />
                                </Box>
                                <Box sx={{ position: 'absolute', inset: 0, background: 'linear-gradient(0deg, rgba(0,0,0,0.4) 0%, transparent 40%)' }} />
                            </Box>
                            ...
                            <Box sx={{
                                ...
                                <Box className="gallery-img" sx={{ position: 'absolute', inset: 0, transition: 'transform 0.6s ease' }}>
                                    <StaticImage src="../images/2026/2026-20.jpg" alt="Leefstijl voeding" style={{ width: '100%', height: '100%', objectFit: 'cover' }} />
                                </Box>
                            </Box>
                            ...
                            <Box sx={{
                                ...
                                <Box className="gallery-img" sx={{ position: 'absolute', inset: 0, transition: 'transform 0.6s ease' }}>
                                    <StaticImage src="../images/2026/2026-19.jpg" alt="Leefstijl training" style={{ width: '100%', height: '100%', objectFit: 'cover' }} />
                                </Box>
                            </Box>
                            ...
                            <Box sx={{
                                ...
                                <Box className="gallery-img" sx={{ position: 'absolute', inset: 0, transition: 'transform 0.6s ease' }}>
                                    <StaticImage src="../images/2026/2026-34.jpg" alt="Leefstijl balans" style={{ width: '100%', height: '100%', objectFit: 'cover' }} />
                                </Box>
                                <Box sx={{ position: 'absolute', inset: 0, background: 'linear-gradient(0deg, rgba(0,0,0,0.4) 0%, transparent 40%)' }} />
                            </Box>
                        </Box>
