        ...
        <Layout location={props.location}>
            ...
            <Box sx={{ backgroundColor: theme.palette.grey[100] }} component="section">
                <DefaultContainer maxWidth="lg" sx={{ textAlign: 'center' }} doublePadding={true}>
                    ...
                    <Grid2 container spacing={isMobile ? 3 : 5} sx={{ py: isMobile ? 5 : 10, textAlign: 'left', alignItems: 'center' }}>
                        <Grid2 xs={12} md={6} sx={{ order: isMobile ? 2 : 1 }}>
                            <Box sx={{
                                display: 'grid',
                        ...
                        <Grid2 xs={12} md={6} sx={{ order: isMobile ? 1 : 2 }}>
                    ...
                    <Box sx={{ color: theme.palette.common.white, pt: isMobile ? 5 : 10 }}>
                        <Grid2 container spacing={isMobile ? 3 : 5} sx={{ textAlign: 'left' }}>
                            ...
                            <Grid2 xs={12} sx={{ textAlign: 'center', pt: 2 }}>
                                <Box sx={{
                                    maxWidth: '700px',
                                    mx: 'auto',
                                    py: 4,
                            ...
                            <Grid2 xs={12} sx={{ pt: isMobile ? 3 : 6 }}>
                                <Divider />
                            </Grid2>

                            <Grid2 xs={12} sx={{ textAlign: 'center', pb: 4 }}>
                                ...
                                <Box sx={{
                                    ...
                                    <Box sx={{
                                        ...
                                        <Box className="seq-img" sx={{ position: 'absolute', inset: 0, transition: 'transform 0.5s ease' }}>
                                            <StaticImage src="../images/2026/2026-10.jpg" alt="Hammer training 1" style={{ width: '100%', height: '100%', objectFit: 'cover' }} />
                                        </Box>
                                    ...
                                    <Box sx={{
                                        ...
                                        <Box className="seq-img" sx={{ position: 'absolute', inset: 0, transition: 'transform 0.5s ease' }}>
                                            <StaticImage src="../images/2026/2026-11.jpg" alt="Hammer training 2" style={{ width: '100%', height: '100%', objectFit: 'cover' }} />
                                        </Box>
                                        <Box className="seq-overlay" sx={{ position: 'absolute', inset: 0, background: 'linear-gradient(0deg, rgba(0,0,0,0.5) 0%, transparent 50%)', transition: 'opacity 0.4s ease' }} />
                                    ...
                                    <Box sx={{
                                        ...
                                        <Box className="seq-img" sx={{ position: 'absolute', inset: 0, transition: 'transform 0.5s ease' }}>
                                            <StaticImage src="../images/2026/2026-12.jpg" alt="Hammer training 3" style={{ width: '100%', height: '100%', objectFit: 'cover' }} />
                                        </Box>
                                        <Box className="seq-overlay" sx={{ position: 'absolute', inset: 0, background: 'linear-gradient(0deg, rgba(0,0,0,0.5) 0%, transparent 50%)', transition: 'opacity 0.4s ease' }} />
                                    ...
                                    <Box sx={{
                                        ...
                                        <Box className="seq-img" sx={{ position: 'absolute', inset: 0, transition: 'transform 0.5s ease' }}>
                                            <StaticImage src="../images/2026/2026-13.jpg" alt="Hammer training 4" style={{ width: '100%', height: '100%', objectFit: 'cover' }} />
                                        </Box>
                                        <Box className="seq-overlay" sx={{ position: 'absolute', inset: 0, background: 'linear-gradient(0deg, rgba(0,0,0,0.5) 0%, transparent 50%)', transition: 'opacity 0.4s ease' }} />
                            ...
                            <Grid2 xs={12} md={4}>
                                <Box sx={{ borderRadius: 3, overflow: 'hidden', boxShadow: '0 8px 30px rgba(0,0,0,0.3)', height: isMobile ? 250 : 350, position: 'relative', '&:hover .seq-img': { transform: 'scale(1.08)' } }}>
                                    <Box className="seq-img" sx={{ position: 'absolute', inset: 0, transition: 'transform 0.5s ease' }}>
                                        <StaticImage src="../images/2026/2026-14.jpg" alt="Studio sfeer" style={{ width: '100%', height: '100%', objectFit: 'cover' }} />
                                    </Box>
                                </Box>
                            </Grid2>
                            <Grid2 xs={12} md={4}>
                                <Box sx={{ borderRadius: 3, overflow: 'hidden', boxShadow: '0 8px 30px rgba(0,0,0,0.3)', height: isMobile ? 250 : 350, position: 'relative', '&:hover .seq-img': { transform: 'scale(1.08)' } }}>
                                    <Box className="seq-img" sx={{ position: 'absolute', inset: 0, transition: 'transform 0.5s ease' }}>
                                        <StaticImage src="../images/2026/2026-15.jpg" alt="Studio sfeer" style={{ width: '100%', height: '100%', objectFit: 'cover' }} />
                                    </Box>
                                </Box>
                            </Grid2>
                            <Grid2 xs={12} md={4}>
                                <Box sx={{ borderRadius: 3, overflow: 'hidden', boxShadow: '0 8px 30px rgba(0,0,0,0.3)', height: isMobile ? 250 : 350, position: 'relative', '&:hover .seq-img': { transform: 'scale(1.08)' } }}>
                                    <Box className="seq-img" sx={{ position: 'absolute', inset: 0, transition: 'transform 0.5s ease' }}>
                                        <StaticImage src="../images/2026/2026-16.jpg" alt="Studio sfeer" style={{ width: '100%', height: '100%', objectFit: 'cover' }} />
                                    </Box>
                                </Box>
                            </Grid2>
                            ...
                            <Grid2 xs={12}>
                                <Box sx={{ borderRadius: 3, overflow: 'hidden', boxShadow: '0 8px 30px rgba(0,0,0,0.3)', height: isMobile ? 250 : 400, position: 'relative', '&:hover .seq-img': { transform: 'scale(1.05)' } }}>
                                    <Box className="seq-img" sx={{ position: 'absolute', inset: 0, transition: 'transform 0.5s ease' }}>
                                        <StaticImage src="../images/2026/2026-17.jpg" alt="Studio overzicht" style={{ width: '100%', height: '100%', objectFit: 'cover' }} />
                                    </Box>
                                </Box>
                            </Grid2>
                        </Grid2>
