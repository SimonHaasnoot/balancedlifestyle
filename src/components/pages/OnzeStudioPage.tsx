                ...
                <Box sx={{ backgroundColor: theme.palette.grey[100] }} component="section">
                    <DefaultContainer maxWidth="lg" sx={{ textAlign: 'center' }} doublePadding={true}>
                        ...
                        <Typography variant="body1" sx={{ color: theme.palette.common.white, mb: 5 }}>
                            Een studio waar jouw vitaliteit centraal staat – zowel fysiek als mentaal. Samen werken we aan een sterkere en fittere
                            versie van jezelf door middel van krachttraining en conditietraining. Daarnaast hechten we ook waarde aan jouw mentale
                            welzijn, omdat fysieke en mentale kracht hand in hand gaan.
                        </Typography>
                        ...
                        <Box
                            sx={{
                                display: 'grid',
                                gridTemplateColumns: isMobile ? '1fr' : '4fr 9fr',
                                gap: isMobile ? 2 : 3,
                                mt: isMobile ? 4 : 8,
                            }}
                        >
                            ...
                            >
                                <OptimizedImage
                                    src="/images/2026/onze-studio/1.jpg"
                                    alt="Onze studio"
                            ...
                            >
                                <OptimizedImage
                                    src="/images/2026/onze-studio/2.jpg"
                                    alt="Onze studio"
                                    style={{ width: '100%', height: '100%', objectFit: 'cover', display: 'block' }}
                                />
                            </Box>
                            ...
                            <Grid size={{ xs: 12, md: 6 }} sx={{ order: isMobile ? 1 : 2 }}>
                                ...
                                >
                                    <Typography variant="body1" sx={{ color: theme.palette.common.white, lineHeight: 1.9 }}>
                                        Kim is in <span>twee jaar</span> tijd <span>20 kg</span> afgevallen en heeft haar mindset volledig veranderd.
                                        Van onzeker en te zwaar naar <span>zelfverzekerd</span> en <span>sportief</span>.
                                        <br />
                                        <br />
                                        Met <span>krachttraining</span> en <span>persoonlijke begeleiding</span> ontdekte ze de impact van een{' '}
                                        <span>gezonde levensstijl</span>. Door balans in haar <span>mentale</span> en <span>fysieke</span> gesteldheid
                                        haalt ze nu wekelijks het maximale uit haar leven.
                                        <br />
                                        <br />
                                        Sporten helpt haar om <span>negatieve gevoelens</span> en <span>gedachten</span> te overwinnen. Ze is de baas
                                        over haar lichaam en maakt keuzes waar ze <span>trots</span> op is.
                                        <br />
                                        <br />
                                        Ook nu ze haar doelen heeft bereikt, blijft ze terugkomen, omdat ze de <span>waarde</span> ervan inziet. Op
                                        goede én slechte dagen krijgt ze dat <span>zetje</span> in de juiste richting.
                                    </Typography>
                                </Box>
                                <Typography variant="body1" sx={{ color: theme.palette.common.white, opacity: 0.8, fontStyle: 'italic' }}>
                                    Als je met deze elementen een tijdje actief bezig bent ga je <span>regelmaat</span> creëren. Uit regelmaat
                                    ontstaat een ritme wat uiteindelijk ontwikkeld naar gewoontes.
                                </Typography>
                            </Grid>
                        </Grid>
                        ...
                        <Box sx={{ color: theme.palette.common.white, pt: isMobile ? 5 : 10 }}>
                            <Grid container spacing={isMobile ? 3 : 5} sx={{ textAlign: 'left' }}>
                                ...
                                <Grid size={12} sx={{ textAlign: 'center', pt: 2 }}>
                                    ...
                                    >
                                        <Typography variant="body1" sx={{ color: theme.palette.common.white, lineHeight: 1.9 }}>
                                            Door het behouden van een gebalanceerde levensstijl voelt Kim zich <span>vrijer dan ooit</span> en is ze
                                            gelukkig met haar lichaam. Laat haar jou inspireren om ook de eerste stap te zetten naar een gezonder en
                                            gelukkiger bestaan.
                                        </Typography>
                                        <Box
                                            sx={{
                                        ...
                                        <Typography
                                            variant="body2"
                                            sx={{ color: theme.palette.common.white, opacity: 0.7, fontStyle: 'italic', lineHeight: 1.8 }}
                                        >
                                ...
                                <Grid size={12} sx={{ textAlign: 'center', pb: 4 }}>
                                    <Typography
                                        variant="body1"
                                        sx={{ color: theme.palette.common.white, maxWidth: '750px', mx: 'auto', lineHeight: 1.9 }}
                                    >
                                        Bij Lifestyle & Personal Training Zeist, een paramedisch centrum, draait het om een holistische benadering van
                                        gezondheid. Niet alleen sporten, maar je gehele levensstijl staat centraal.
                                        <br />
                                        <br />
                                        We creëren een veilige en vertrouwde omgeving, zodat jij zonder druk kunt werken aan de beste versie van
                                        jezelf.
                                        <br />
                                        <br />
                                        Naast krachttraining en coaching bieden we begeleiding van een orthomoleculair diëtist. Iedereen is uniek –
                                        wat voor de één werkt, is anders voor de ander.
                                        <br />
                                        <br />
                                    ...
                                    >
                                        ...
                                        >
                                            <Box className="seq-img" sx={{ position: 'absolute', inset: 0, transition: 'transform 0.5s ease' }}>
                                                <OptimizedImage
                                                    src="/images/2026/2026-10.jpg"
                                                    alt="Hammer training 1"
                                                    style={{ width: '100%', height: '100%', objectFit: 'cover' }}
                                                />
                                            </Box>
                                            <Box
                                                className="seq-overlay"
                                                sx={{
                                                    position: 'absolute',
                                                    inset: 0,
                                        ...
                                        >
                                            <Box className="seq-img" sx={{ position: 'absolute', inset: 0, transition: 'transform 0.5s ease' }}>
                                                <OptimizedImage
                                                    src="/images/2026/2026-11.jpg"
                                                    alt="Hammer training 2"
                                                    style={{ width: '100%', height: '100%', objectFit: 'cover' }}
                                                />
                                            </Box>
                                            <Box
                                        ...
                                        >
                                            <Box className="seq-img" sx={{ position: 'absolute', inset: 0, transition: 'transform 0.5s ease' }}>
                                                <OptimizedImage
                                                    src="/images/2026/2026-12.jpg"
                                                    alt="Hammer training 3"
                                                    style={{ width: '100%', height: '100%', objectFit: 'cover' }}
                                                />
                                            </Box>
                                            <Box
                                        ...
                                        >
                                            <Box className="seq-img" sx={{ position: 'absolute', inset: 0, transition: 'transform 0.5s ease' }}>
                                                <OptimizedImage
                                                    src="/images/2026/2026-13.jpg"
                                                    alt="Hammer training 4"
                                                    style={{ width: '100%', height: '100%', objectFit: 'cover' }}
                                                />
                                            </Box>
                                            <Box
